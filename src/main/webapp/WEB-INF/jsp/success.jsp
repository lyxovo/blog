...
<body>
	...
	<div id="middle_main" style="width:800px;height:400px; position:relative;top:150px;margin:0 auto;background-color:white;">
			...
			<div id="middle_core1" style="width:680px;height:30px;position:relative;top:30px;margin:0 auto">
				<a  href="#" style="float: left;">&lt;管理博文</a>
			</div>
			
			<div id="middle_core2" style="width:680px;height:160px; position:relative;top:50px;margin:0 auto;background-color:#EBEBE4">
				<h2 style="text-align: left;margin-top:10px; ">加了开始的减肥受得了咖啡机时空裂缝</h2>
				<textarea rows="5" cols="94" maxlength="130" disabled="disabled" style="resize: none;text-align: left;margin-top:7px;border:none;">
				p属性来设那么整个div就居中了。那怎么让它中心移动到红线处自身高度的一半。这时候，我们可以使用通过margin-top属性来设：p属性来设那么整个div就居中了。那怎么让它中心移动到红线处自身高度的一半。这时候，我们可以使用通过margin-top属性来设：
				</textarea>
			...
			<div id="middle_core3" style="width:680px;height:30px; position:relative;top:100px;margin:0 auto">
				...
				<a href="#" style="margin-left:90px;"><i class="layui-icon layui-icon-edit"></i>再写一篇</a>
			</div>
	</div>
